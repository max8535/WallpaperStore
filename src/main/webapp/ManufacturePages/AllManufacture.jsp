...
<div style="height: 100%; overflow:auto;">
    ...
    <div>
        <table style="width: 100%" class="table">
            ...
            <c:forEach items="${All}" var="s">
                <tr>
                    ...
                    <td><a href="UpdateManufactureServlet?id=${s.ID}">Изменить</a></td>
                    <td><a href="DeleteManufactureServlet?id=${s.ID}">Удалить</a></td>
                </tr>
            </c:forEach>
        </table>


        <button class="btn btn-primary" onclick="window.location.href = 'http://localhost:8082/WallpaperStore_war/AddManufactureServlet';">Добавить нового производителя</button>
        <br>
        <!-- <button style="margin-left: 800px; align :center;margin-top: 50px" class="btn btn-primary" onclick="window.location.href = 'http://localhost:8082/WallpaperStore_war/QueryManufactureServlet';">Получить результаты запроса</button>
        ...
        <table style="width: 20%; justify-content: center" class="table">
            ...
            <c:forEach items="${getManufacture}" var="c">
                <tr>
                    <td>${c.ID}</td>
                    <td>${c.name}
                    </td>
