...
<form action="AddDeliveryServlet" method="post">
    ...
    <div class="input">
        <label for="amount">Размер поставки,м2</label>
    ...
    <button class="btn btn-primary" style="width: 50%" onclick="window.location.href = 'http://localhost:8082/WallpaperStore_war/AllDeliveryServlet';">Отменить</button>
</form>
