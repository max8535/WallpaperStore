        ...
        <form action="AddItemServlet" method="post">
            ...
            <div class="input">
                ...
                <select name="manufacture" id="manufacture">
                    <c:forEach items="${getAllManufacture}" var="b">
            ...
            <div class="input">
                ...
                <button class="btn btn-primary" style="width: 50%" onclick="window.location.href = 'http://localhost:8082/WallpaperStore_war/AllItemsServlet';">Отменить</button>
        </form>
