        ...
        <table style="width: 100%" class="table">
            ...
            <c:forEach items="${All}" var="s">
                <tr>
                    ...
                    <td><a href="UpdateCategoryServlet?id=${s.ID}">Изменить</a></td>
                    <td><a href="DeleteCategoryServlet?id=${s.ID}">Удалить</a></td>
                </tr>
            </c:forEach>
        </table>


        <button class="btn btn-primary" onclick="window.location.href = 'http://localhost:8082/WallpaperStore_war/AddCategoryServlet';">Добавить новую категорию</button>
        <br>
