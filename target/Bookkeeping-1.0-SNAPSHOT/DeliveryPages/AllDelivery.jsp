...
<div style="height: 100%; overflow:auto;">
    ...
    <div>
        <table style="width: 100%" class="table">
            ...
            <c:forEach items="${All}" var="s">
                <tr>
                    ...
                    <td>${s.delivery_amount}</td>
                    <td><a href="UpdateDeliveryServlet?id=${s.ID}">Изменить</a></td>
                    <td><a href="DeleteDeliveryServlet?id=${s.ID}">Удалить</a></td>
                </tr>
            </c:forEach>
        </table>
        <button class="btn btn-primary" onclick="window.location.href = 'http://localhost:8082/WallpaperStore_war/AddDeliveryServlet';">Добавьте новую поставку</button>
        <br>
        ...
        <table style="width: 20%; justify-content: center" class="table">
            ...
            <c:forEach items="${getDelivery}" var="c">
                <tr>
                    <td>${s.ID}</td>
                    <td>
                        Название: ${s.store.name}<br>
